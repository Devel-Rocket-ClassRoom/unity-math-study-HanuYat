...
public class Assignment_GachaSimulator : MonoBehaviour
{
    ...
    private void ExecutePull()
    {
        ...
        {
            float increaseRate = ((1.0f - baseRate) / hardPity) * currentPityCount;
            currentEffectiveRate = Mathf.Clamp01(increaseRate);
        }
